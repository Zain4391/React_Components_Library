...
const modalVariants = cva(
  [
    'relative bg-[var(--color-surface-raised)] rounded-lg shadow-[var(--shadow-lg)] border border-[var(--color-border)] flex flex-col max-h-[90vh]',
...
export function Modal({ isOpen, onClose, title, footer, size = 'md', children }: ModalProps) {
  ...
  return (
    <dialog
      ...
      className="p-0 backdrop:bg-[var(--color-overlay)] backdrop:backdrop-blur-sm bg-transparent m-auto"
    >
